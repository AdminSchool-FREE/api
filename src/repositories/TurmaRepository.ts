...
export async function alterarNomeTurma(nome: string, idEscola: string, idTurma: string){
...
export async function salvarChamadaTurma(dadosChamada: Array<ChamadaTurmaProps>){
